        ...
        <div className="flex flex-col min-h-screen bg-[#FF6B00] text-black font-sans antialiased">
            ...
            <header className="bg-[#FF6B00] sticky top-0 z-30">
                <div className="px-4 py-3 flex items-center justify-between">
                    ...
                    <h1 className="text-lg font-black text-white tracking-tight text-center flex-1 lowercase">perfil de companhia</h1>
            ...
            <main className="flex-1 overflow-y-auto px-4 py-4 pb-24 no-scrollbar">
                <div className="bg-[#FFF5EE] rounded-[32px] p-8 shadow-xl animate-in fade-in slide-in-from-bottom-4 duration-500">
                    <h2 className="text-2xl font-black text-[#111] mb-6 tracking-tight">perfil de companhia</h2>
                    ...
                    <div className="text-[14px] text-gray-800 leading-relaxed space-y-6 font-medium">
                        ...
                        <div className="space-y-4">
                            <h3 className="text-lg font-black text-[#111] border-l-4 border-[#FF6B00] pl-3">Perfil da empresa</h3>
                            <ul className="space-y-2">
                                <li><strong className="text-black font-black">Nome:</strong> The Home Depot, Inc. (Home Depot).</li>
                                <li><strong className="text-black font-black">Sede:</strong> Atlanta, Geórgia, EUA.</li>
                                <li><strong className="text-black font-black">Fundada:</strong> 1978.</li>
                                <li><strong className="text-black font-black">Negócio principal:</strong> venda de uma variedade de materiais de construção, produtos de reforma residencial, ferramentas, suprimentos para gramados e jardins e fornecimento de serviços de instalação e aluguel.</li>
                                <li><strong className="text-black font-black">Grupos de clientes:</strong> consumidores de bricolagem, proprietários de casas que precisam contratar profissionais (DIFM), empreiteiros profissionais e empresários.</li>
                                <li><strong className="text-black font-black">Mercado:</strong> O maior varejista de construção do mundo, com negócios abrangendo os Estados Unidos, Canadá e México, e uma forte plataforma de comércio eletrônico.</li>
                                <li><strong className="text-black font-black">Escala:</strong> Milhares de grandes shopping centers, centenas de milhares de funcionários.</li>
                                <li><strong className="text-black font-black">Listagem:</strong> O código de ações HD, listado na Bolsa de Valores de Nova York, é um componente do Índice Dow Jones e do Índice S&P 500.</li>
                            </ul>
                        </div>

                        <div className="space-y-4">
                            <h3 className="text-lg font-black text-[#111] border-l-4 border-[#FF6B00] pl-3">Características principais</h3>
                            <div className="space-y-4">
                                <div>
                                    <strong className="text-black font-black block mb-1 uppercase text-xs tracking-widest text-[#FF6B00]">Compra completa</strong>
                                ...
                                <div>
                                    <strong className="text-black font-black block mb-1 uppercase text-xs tracking-widest text-[#FF6B00]">Serviços diversificados</strong>
                                ...
                                <div>
                                    <strong className="text-black font-black block mb-1 uppercase text-xs tracking-widest text-[#FF6B00]">Forte influência da marca</strong>
